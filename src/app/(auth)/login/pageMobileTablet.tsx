...
const PageMobileTablet: React.FC<LoginProps> = ({ redirectToRegister, redirectToLogin,  validateField,  formik,  isEmailError, isPasswordError,  formErrors,  showPassword, togglePasswordVisibility }) => {
    return (
        <>
            <div className="h-screen flex justify-center items-center bg-[#EEF1F7] overflow-x-hidden">
                <form onSubmit={formik.isSubmitting ? () => { } : formik.handleSubmit} className="flex flex-col space-y-4 w-full">
