...
const useGetAccountActiveSent = (
    token: string,
) => {
    const cacheKey = 'account-active-sent';
    ...
    return useQuery<ApiResponse>({
        queryKey: ["useGetAccountActiveSent", token],
        queryFn: async () => {
            ...
            const response = await axiosInstance.get<ApiResponse>(`/auth/account-active/status/${token}`, {
                headers,
                validateStatus: () => true,
            });
...
export { useGetAccountActiveSent };
