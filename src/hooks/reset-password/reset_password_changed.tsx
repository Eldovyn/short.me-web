...
const useGetResetPasswordChanged = (
    token: string,
) => {
    const cacheKey = 'reset-password-changed';
    ...
    return useQuery<ApiResponse>({
        queryKey: ["useGetResetPasswordChanged", token],
        queryFn: async () => {
            ...
            const response = await axiosInstance.get<ApiResponse>(`/auth/reset-password/password-changed/${token}`, {
                headers,
                validateStatus: () => true,
            });
...
export { useGetResetPasswordChanged };
